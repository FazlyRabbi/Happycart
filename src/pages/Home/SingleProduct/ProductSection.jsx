    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2'>
            ...
            <div className="">
                ...
                <button className="bg-blue-500 text-white rounded-md py-2 px-4" onClick={() => setShow(!show)}>Show More</button>
            </div>
            <div className=" p-4 border-2 border-gray-800 rounded-md col-span-3 m-4  md:col-span-1">
